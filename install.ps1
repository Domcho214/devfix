...
try {
    ...
    Write-Host "Failed to download devfix. Prosim preveri GitHub povezavo." -ForegroundColor Red
...
if ($UserPath -notlike "*$InstallDir*") {
    Write-Host "Dodajam devfix v tvoj PATH..."
...
Write-Host "  devfix je bil uspesno namescen!        " -ForegroundColor Green
Write-Host "=========================================" -ForegroundColor Green
Write-Host "`nSedaj ga lahko pozenes od kjerkoli z ukazom:" -ForegroundColor White
